package net.mattlabs.skipnight.impl.base.commands;
...
public class BaseSkipNightCommand {

    LegacyPaperCommandManager<CommandSender> commandManager;
    Vote vote;

    public BaseSkipNightCommand(LegacyPaperCommandManager<CommandSender> commandManager, Vote vote) {
        this.vote = vote;
