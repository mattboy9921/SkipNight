...
public class Paper1206SkipNightCommand {

    PaperCommandManager<Source> commandManager;
    Vote vote;

    public Paper1206SkipNightCommand(PaperCommandManager<Source> commandManager, Vote vote) {
        this.vote = vote;
    ...
    private void commands() {
        ...
        Command.Builder<Source> builder = commandManager.commandBuilder("skipnight", "sn")
